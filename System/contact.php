			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/job2.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Thyagarajanagar, <br/> Doddaballapura, <br/>Bangalore</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:kruthagnakuruba@gmail.com">kruthagnakuruba@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About this job portal</h5>
											<p>Online job portal, online job management system developed by kruthagna in 2022</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title"> Jobs Contact</h5>
								
								<p>Address : Doddaballapur,Banglore rural district-561203</p>
								<p>Email : <a href="mailto:kruthagnakuruba@gmail.com">kruthagnakuruba@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Online job Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by kruthagna</a></li>
								</ul>
