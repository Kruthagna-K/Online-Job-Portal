...
<head>
	...
	<title>Online job potal - Job Portal</title>
				...
				<div class="container">
					...
					<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-4">
									...
									<div class="footer-about-us">
										<h5 class="footer-title">About Online Jobs</h5>
										<p>Job portal, online job management system developed by Kruthagna.</p>
						...
						<div class="col-sm-12 col-md-3 mt-30-sm">
							...
							<p>Address :Doddaballapura, Banglore rural district-561203</p>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							...
							<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Online Job portal Software</p>
